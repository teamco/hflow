...
import styles from '@/pages/roles/componentRoles/componentRoles.module.less';
 ...
 * @return {JSX.Element}
 */
export const componentRoles = props => {
      ...
      <Page spinEffects={[
        ...
        <div className={styles.preparationWrapper}>
          ...
          <Form layout={'vertical'}
                ...
                fields={entityForm}
                onFinish={onFinish}>
            <GenericPanel header={t(intl, 'panel.componentRoles')}
                          name={'componentRoles'}
                          defaultActiveKey={['componentRoles']}>
