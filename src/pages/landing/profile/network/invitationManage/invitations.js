...
import styles from '@/pages/landing/profile/network/sections/invitations.module.less';
...
export const NetworkInvitations = (props) => {
  ...
  return (
      <div className={styles.networkInvitations}>
        <Spin spinning={!content || isSpinning(loading, [`${MODEL_NAME}/query`])}>
          <Row>
            <Col span={16}>{getInvitationsCard()}</Col>
            <Col span={8}></Col>
          </Row>
