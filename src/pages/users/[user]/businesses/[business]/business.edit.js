...
import { BusinessService } from 'pages/users/[user]/businesses/[business]/form/business.service';
    ...
    return (
      <Page className={userStyles.users}
            ...
            spinEffects={[
              ...
              'businessPreparationModel/query',
              'businessServiceModel/query',
              'dietaryModel/query',
              'startersAndDessertsModel/query'
            ]}>
